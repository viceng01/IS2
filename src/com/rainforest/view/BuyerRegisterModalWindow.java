...
public class BuyerRegisterModalWindow extends JDialog implements ActionListener {
	...
	public BuyerRegisterModalWindow(MainWindow mainWindow, ControlPanel cp) {
		mw = mainWindow;
		this.cp = cp;
		initGUI(mainWindow);
	}
	...
	private JPanel createFormPanel() {
		...
		vGroup.addGroup(
				formLayout.createParallelGroup(Alignment.BASELINE).addComponent(dir).addComponent(dirTextField));
		vGroup.addGroup(
				formLayout.createParallelGroup(Alignment.BASELINE).addComponent(dni).addComponent(dniTextField));
		vGroup.addGroup(
				formLayout.createParallelGroup(Alignment.BASELINE).addComponent(tel).addComponent(telTextField));
